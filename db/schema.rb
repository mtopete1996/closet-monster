...
ActiveRecord::Schema.define(version: 2022_01_20_042023) do
  ...
  create_table "cloth_logs", force: :cascade do |t|
    t.datetime "worn_at", null: false
    t.bigint "cloth_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["cloth_id"], name: "index_cloth_logs_on_cloth_id"
  end
  ...
  add_foreign_key "cloth_logs", "cloths"
